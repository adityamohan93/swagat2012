jQuery.noConflict()
jQuery.imageMagnify={dsettings:{magnifyby:3,duration:500,imgopacity:0.2},cursorcss:'url(magnify.cur), -moz-zoom-in',zIndexcounter:100,refreshoffsets:function($window,$target,warpshell){var $offsets=$target.offset()
